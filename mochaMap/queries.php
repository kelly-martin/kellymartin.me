<?php
  ...
  // connect to database
  $connection = mysqli_connect($servername, $database, $password, $username);
  ...
  if ($_GET['query'] == "addCoffeeShop") {
    ...
    echo "<strong>Success!</strong> This coffee shop has been added to your MochaMap.";
  ...
  if ($_GET['query'] == "updateCoffeeShop") {
    ...
    echo "<strong>Success!</strong> This coffee shop has been updated on your MochaMap.";
